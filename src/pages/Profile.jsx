              ...
              <Col lg="6" className="profile-details">
                <div>
                  ...
                  <h3 className="profile-name mt-3">
                    User Name : {myProfile?.displayName}
                  </h3>
                </div>
                <div>
                  <h3 className="profile-email mt-3">
                ...
                />
                <button
                  className="btn btn-primary profile-update-btn mt-5 p-2 m-3"
                  onClick={handleUpdatePassword}
                >
                  Update Password
                </button>
                <button
                  className="btn btn-danger profile-delete-btn mt-5 p-2 m-3"
